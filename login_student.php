...
if(isset($_POST['submit'])){
    ...
    $select_student = "select student_id, name, password from students where rollno='$name' and password='$password'";
...
<body>
    ...
    <div class="main">
        ...
        <form class="form1" method="post">
            <input class="name" name="name" type="text" align="center" placeholder="Student Id">
            <input class="pass" name="password" type="password" align="center" placeholder="Password">
            <button class="submit" name="submit" type="submit" align="center" style="background:grey">LOGIN</button>
            <p align=center class="role-msg">Are you a Admin? <a href="index.php">Login Here</a></p>
    </div>
</body>
</html>